...
#define t_error_value 0xffffffff
    ...
    public:
        ...
        inline void setInt64(const int64 value) {
    ...
    public:
        ...
        inline int64 getInt64(const int index) const {
    ...
    private:
        inline void pushInt64(const int64 value) {
