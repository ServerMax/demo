...
namespace tools {
    ...
    namespace file {
        ...
        bool getfiles(const char * dicpath, const char * extension, OUT opaths & paths, OUT onames & names, OUT int32 & count) {
    ...
    const std::string toUtf8(const char* font) {
        int32 len = MultiByteToWideChar(CP_ACP, 0, font, -1, nullptr, 0);
