...
namespace tcore {
    ...
    udper::udper(iUdpSession * session, const std::string & ip, const int32 port)
        : _session(session),
    ...
    udper * udper::create(iUdpSession * session, const std::string & ip, const int32 port) {
    ...
    void udper::sendto(const char * ip, const int32 port, const void * data, const int32 size) {
        sockaddr_in remote;
    ...
    void udper::connect(const char * ip, const int32 port) {
    ...
    void udper::onCompleter(overlappedex * ex, const eCompletion type, const int32 code, const int32 size) {
