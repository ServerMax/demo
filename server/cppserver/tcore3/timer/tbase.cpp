...
namespace tcore {
    ...
    tbase * tbase::Create(iTimer * timer, const int32 id, const iContext & context, int32 count, int64 interval, const char * file, const int32 line) {
        return create_from_pool(s_pool, timer, id, context, count, interval, file, line);
    }

    tbase::tbase(iTimer * timer, const int32 id, const iContext & context, int32 count, int64 interval, const char * file, const int32 line)
