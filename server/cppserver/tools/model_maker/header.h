...
\n\
        layout(const char * name, int16 index, int32 offset, int8 type, int16 size, bool visual, bool share, bool save, bool important) : _name(name), _index(index), _offset(offset), _type(type), _size(size), _visual(visual), _share(share), _save(save), _important(important) {}\n\
    };\n";
