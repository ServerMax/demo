...
namespace tcore {
    namespace api {
        struct oAddress {
            ...
            oAddress(const std::string & ip, const int32 port) :_ip(ip), _port(port) {}
        };
        ...
        public:
            virtual ~iUdpPipe() {}
            virtual void sendto(const char * ip, const int32 port, const void * context, const int32 size) = 0;
        ...
        public:
            ...
            virtual void onRecv(iCore * core, const char * ip, const int32 port, const char * data, const int size) = 0;
            ...
            inline void sendto(const char * ip, const int32 port, const void * context, const int size) const {
        ...
        public:
            ...
            virtual iUdpSession * onMallocConnection(iCore * core, const char * ip, const int32 port) = 0;
        ...
        public:
            virtual ~iTcpPipe() {}
            virtual void send(const void * data, const int32 size, bool immediately) = 0;
        };
        ...
        public:
            ...
            virtual iTcpSession * onMallocConnection(iCore * core, const char * remote_ip, const int32 remote_port) = 0;
        ...
        public:
            ...
            virtual void broadcast(const void * context, const int32 size) = 0;
        };

        struct iContext {
            union {
                const void * _context_point;
                const int64 _context_mark;
            };
            iContext(const void * point) : _context_point(point) {}
            iContext(const int64 mark) : _context_mark(mark) {}
        };
        ...
        public:
            ...
            virtual void onStart(iCore * core, const int32 id, const iContext & context, const int64 tick) = 0;
            virtual void onTimer(iCore * core, const int32 id, const iContext & context, const int64 tick) = 0;
            virtual void onEnd(iCore * core, const int32 id, const iContext & context, bool nonviolent, const int64 tick) = 0;
            virtual void onPause(iCore * core, const int32 id, const iContext & context, const int64 tick) = 0;
            virtual void onResume(iCore * core, const int32 id, const iContext & context, const int64 tick) = 0;
        };

        class iHttpRequest {
        public:
            virtual ~iHttpRequest() {}
            virtual void postParam(const char * key, const uint64 value) {
        ...
        public:
            ...
            virtual void onError(const int32 id, const int32 error, const std::string & url, const std::string & params, const iContext & context) = 0;
            virtual void onResponse(const int32 id, const std::string & url, const std::string & params, const void * data, const int32 size, const iContext & context) = 0;
        ...
        public:
            ...
            virtual void onSetComplete(const uint32 id, bool success, const char * key, const char * data, const uint32 size, const iContext context) = 0;
            virtual void onGetComplete(const uint32 id, bool success, const char * key, const char * data, const uint32 size, const iContext context) = 0;
            virtual void onDelComplete(const uint32 id, bool success, const char * key, const iContext context) = 0;
        };

        typedef std::function<void(const uint32 id, const tlib::cargs& results, const iContext context)> fRdsTransactionCall;
        ...
        public:
            ...
            virtual void doTransacation(const uint32 id, const fRdsTransactionCall& call, bool sync = true, const iContext context = int64(0)) = 0;
        };

        typedef std::function<void(const uint32 id, bool success, const char* key, const char* data, const uint32 size, const iContext context)> fRedisCall;
        class iRediser {
        public:
            virtual ~iRediser() {}
            virtual void completerSet(const uint32 id, const char * key, iRedisCompleter * completer, const void * data, const uint32 len, bool sync = false, const iContext context = int64(0)) = 0;
            virtual void completerGet(const uint32 id, const char * key, iRedisCompleter * completer, bool sync = false, const iContext context = int64(0)) = 0;
            virtual void completerDel(const uint32 id, const char * key, iRedisCompleter * completer, bool sync = false, const iContext context = int64(0)) = 0;

            //caller opt sync
            virtual void callerSet(const uint32 id, const char * key, const fRedisCall & call, const void * data, const uint32 len, bool sync = false, const iContext context = int64(0)) = 0;
            virtual void callerGet(const uint32 id, const char * key, const fRedisCall & call, bool sync = false, const iContext context = int64(0)) = 0;
            virtual void callerDel(const uint32 id, const char * key, const fRedisCall & call, bool sync = false, const iContext context = int64(0)) = 0;
...
#       define any_eth "0.0.0.0"
            virtual bool launchUdpSession(iUdpSession * session, const char * ip, const int32 port) = 0;
            ...
            virtual iHttpRequest * getHttpRequest(const uint64 delivery, const int64 id, const char * url, iHttpResponse * response, const iContext & context) = 0;

#       define forever -1
#       define start_timer(core, timer, id, delay, count, interval, context) core->startTimer(timer, id, delay, count, interval, int64(context), __FILE__, __LINE__);
            virtual void startTimer(iTimer * timer, const int32 id, int64 delay, int32 count, int64 interval, const iContext context, const char * file, const int32 line) = 0;
            virtual void killTimer(iTimer * timer, const int32 id, const iContext context = (int64)0) = 0;
            virtual void pauseTimer(iTimer * timer, const int32 id, const iContext context = (int64)0) = 0;
            virtual void resumeTimer(iTimer * timer, const int32 id, const iContext context = (int64)0) = 0;
            ...
            virtual void connectRedis(const char * ip, const int32 port, const char * passwd, const fConnectRedisCall call, const iContext context =int64(0)) = 0;
            ...
            virtual void logSync(const int64 tick, const char * log, const bool echo) = 0;
            virtual void logAsync(const int64 tick, const char * log, const bool echo) = 0;
